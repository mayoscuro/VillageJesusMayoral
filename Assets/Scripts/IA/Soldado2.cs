...
public class Soldado2 : MonoBehaviour {
    ...
    void customUpdate () {
        if (dianoche.currentTimeOfDay >= 0.25f && dianoche.currentTimeOfDay < 0.45 && !final1) {
          
            recorrerNodos(nodosSalida);
            if (final1) {
                x = 0;
            }
        } else if (dianoche.currentTimeOfDay >= 0.45f && dianoche.currentTimeOfDay < 0.65 && !final2) {
        ...
        } else if (dianoche.currentTimeOfDay >= 0.65f && dianoche.currentTimeOfDay < 1 && final2) {
